 ...
 * @author cquatrini
 */
public interface IDataAlternativeRetriever {
   
   public DataAlternativeResponseDTO getSameHotelTypology(DataAlternativeRequestDTO oDataAlternativeResponseDTO);

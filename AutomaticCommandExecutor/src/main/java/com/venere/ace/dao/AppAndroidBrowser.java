 ...
 * @author quatrini
 */
public class AppAndroidBrowser
        extends AHandler
...
//      oBrowser.manage().window().maximize();
   ...
   /**
    * Define a custom delay for driver after click, in particular case it is
    * necessary because the engine doesn't wait automatically
    *
   ...
   /**
    * This method sets a property with the reservation number retrieved from the
    * text of the confirmation. The key of the property is defined by
    * obj.getValue()
    *
    * @param obj
    * @return
...
//         }
   ...
   private void waitFor(int iMillisecond) {
      if (iMillisecond > 0) {

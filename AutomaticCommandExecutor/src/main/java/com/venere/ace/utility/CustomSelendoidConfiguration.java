 ...
 * @author cquatrini
 */
public class CustomSelendoidConfiguration 
//extends SelendroidConfiguration
{

   public void setSupportedApp (String sSupportedApp){
//      this.addSupportedApp(sSupportedApp);
   }
}
